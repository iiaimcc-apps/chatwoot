module Enterprise::Internal::CheckNewVersionsJob
  ...
  def update_plan_info
    # Plan sync disabled: enterprise defaults are managed locally via migrations and installation_config.yml.
    # To re-enable Hub plan sync, remove this early return and restore the original update_installation_config calls.
    nil
  end
